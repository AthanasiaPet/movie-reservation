...
# Technology Stack used: Java, Spring Boot, Spring Security, JWT, MySQL, JPA / Hibernate, Gradle, Swagger (OpenAPI).
...
# Testing: REST API endpoints were tested using Postman (integration testing). Authentication, authorization, and reservation flows were verified through API calls. 
Path: postman/MovieReservationApp.postman_collection.json


# Build and Run instructions: Java 17+, Gradle, MySQL. The backend application runs on http://localhost:8080. The backend is deployed locally for development purposes.

# Frontend Repository: https://github.com/AthanasiaPet/movie-reservation-react
